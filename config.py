...
RTSP_CAMERAS = [
    ...
    # ── KURNOOL — polygon zones
    {
        ...
        "zone_mode": "poly",
        "entry_zone_1_ratios": [[0.4201, 0.3264], [0.5182, 0.3316], [0.5182, 0.4149], [0.3591, 0.4115]],
        "entry_zone_2_ratios": [[0.3032, 0.4497], [0.6822, 0.4549], [0.7803, 0.9444], [0.2256, 0.9514]],
    },
    ...
    # ── MARATHAHALLI BANGLORE — polygon zones
    {
        ...
        "zone_mode": "poly",
        "entry_zone_1_ratios": [[0.0389908, 0.6845056], [0.0527523, 0.7762487], [0.0917431, 0.8802242], [0.1646235, 0.8066744], [0.0951834, 0.6172273]],
        "entry_zone_2_ratios": [[0.1208406, 0.5575987], [0.3188078, 0.9638126], [0.5344036, 0.7334353], [0.6788991, 0.4357798], [0.3993047, 0.3054096], [0.2786697, 0.4092762]],
    },
